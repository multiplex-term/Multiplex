                ...
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 18) {
                        ...
                        feature(
                            ...
                            "Use Claude Code, Codex, and Pi quick commands without the daily limit, browse each session's prompt history with jump-back for Claude Code, and get a banner when an unwatched supported session needs you."
                        )
                        feature(
                            "CUSTOM THEMES",
